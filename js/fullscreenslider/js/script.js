...
$(function() {
	...
	$.template("navboxTemplate", "<div class='navbox ${cssclass}'><ul></ul><h2><a href='${url}' title='${title}'>${title}</a></h2><p>{{html rating}}</p><p><a href='platform/${platformid}/'><img src='images/common/consoles/png24/${icon}' />&nbsp;${text}</a></p></div>");
